...
- 3 à 6 titres de partie (level 1), et des sous-parties (level 2) quand une partie est longue. Suis le découpage du document plutôt que d'en inventer un.
- LES TITRES DE NIVEAU 1 SONT LES CHAPITRES. L'application découpe la fiche à chacun d'eux et en fait une page qu'on ouvre, qu'on lit et qu'on révise séparément. Une fiche qui n'a qu'un seul titre de niveau 1 devient donc UN chapitre unique contenant tout le cours, ce qui est le défaut que ce découpage doit éviter. Il t'en faut au moins trois, et ils doivent nommer des PARTIES du sujet, jamais le sujet lui-même : pas de titre de niveau 1 qui reprenne le nom de la matière ou du deck, et pas de titre en tête de fiche qui serve de titre général. Si tu es tenté d'écrire un titre qui couvre tout, c'est qu'il ne devait pas exister.
