...
final class PaywallTests: XCTestCase {
    ...
    /// La phrase du paywall de fin de parcours dit **une** somme, celle qui sera prélevée.
    /// Elle en disait deux — le mensuel équivalent puis l'annuel entre parenthèses — et le
    /// plus gros des deux arrivait en second, ce qui se lit comme un rattrapage.
    ///
