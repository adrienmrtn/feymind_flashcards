...
/// les tests de mise en page s'appuient dessus.
///
/// Elles exerçaient les douze blocs d'alors : tableaux, graphes, encadrés de ton, définitions
/// encartées. Il n'y a plus que du texte, et c'est ce qu'elles doivent montrer : ce qu'un
/// tableau disait s'écrit en lignes, ce qu'un encadré appuyait s'écrit en gras.
enum SampleData {
    // MARK: - Sciences de la vie

    /// Fiche de référence : elle exerce les quatre blocs et tout le balisage en ligne, y
    /// compris les surligneurs de couleur.
    static let photosynthesisSheet = CourseSheet(blocks: [
        ...
        .paragraph(text: "**Thylakoïde** : sac membranaire empilé à l'intérieur du chloroplaste. Sa membrane porte les pigments qui captent la lumière."),

        .paragraph(text: "**Stroma** : le liquide qui baigne les thylakoïdes. C'est là que le carbone de l'air est fixé sur des molécules organiques."),

        .paragraph(text: "Les deux phases se distinguent sur quatre points, et c'est ce tableau mental qu'un correcteur attend."),

        .list(ordered: false, items: [
            "**Lieu** : thylakoïdes pour la phase photochimique, stroma pour la phase biochimique.",
            "**Lumière** : indispensable à la première, pas directement nécessaire à la seconde.",
            "**Consomme** : eau et lumière d'un côté, CO₂, ATP et NADPH de l'autre.",
            "**Produit** : ATP, NADPH et O₂ d'un côté, glucose de l'autre."
        ]),
        ...
        .paragraph(text: "**Photolyse de l'eau** : rupture de la molécule d'eau sous l'action de la lumière. Elle fournit les électrons de la chaîne photosynthétique et libère le dioxygène."),

        .paragraph(text: "La phase biochimique est souvent appelée *phase sombre*, ce qui laisse croire qu'elle a lieu la nuit. ==menthe|Elle ne consomme pas de lumière, mais elle tourne avec l'ATP et le NADPH fabriqués à la lumière== : à l'obscurité prolongée, elle s'arrête faute de carburant."),
        ...
        .paragraph(text: "**Rubisco** : l'enzyme qui fixe le CO₂, et la protéine la plus abondante de la biosphère. Elle est *lente*, et c'est elle qui plafonne le rendement de toute la photosynthèse."),
        ...
        .paragraph(text: "**Gain de production quand un seul paramètre est corrigé**, sur une culture sous serre déjà bien éclairée."),

        .list(ordered: false, items: [
            "**Air enrichi en CO₂** : 45 %",
            "**Température ramenée à 25 °C** : 22 %",
            "**Éclairage doublé** : 11 %",
            "**Arrosage régulier** : 7 %"
        ]),

        .paragraph(text: "Tiens la chaîne complète et le reste se déduit : la lumière casse l'eau et libère l'oxygène, l'énergie récupérée sert à ==coller le carbone de l'air sur du sucre==. Les noms d'enzymes et de compartiments viennent ensuite.")
    ])

    // MARK: - Mathématiques

    /// Seconde fiche de référence, de matière scientifique : formules dans le texte comme
    /// posées seules, et des listes qui portent ce qu'un tableau portait.
    static let affineFunctionsSheet = CourseSheet(blocks: [
        ...
        .paragraph(text: "**Coefficient directeur** : le nombre a. Il donne la variation de f quand x augmente de 1, et son signe donne le sens de variation de la fonction."),

        .paragraph(text: "**Le signe de a commande tout.**"),

        .list(ordered: false, items: [
            "**a > 0** : la fonction est croissante, la droite monte vers la droite.",
            "**a < 0** : la fonction est décroissante, la droite descend vers la droite.",
        ...
        .paragraph(text: "Un abonnement à 12 € par mois avec 25 € de frais d'ouverture coûte $f(x) = 12x + 25$ après x mois. Le coefficient directeur est le prix mensuel, l'ordonnée à l'origine ce qu'on paie même sans rien consommer."),
        ...
        .paragraph(text: "D'un mois au suivant, l'écart est toujours le même : ==bleu|c'est la signature d'une fonction affine==."),

        .paragraph(text: "Une fonction **linéaire** est une fonction affine dont b vaut 0. La réciproque est fausse : *f(x) = 2x + 3* est affine et n'est pas linéaire. La distinction compte, parce que seule la fonction linéaire traduit une situation de proportionnalité."),

        .paragraph(text: "Trois choses tiennent tout le chapitre : la courbe est une droite, ==a est la pente et b l'ordonnée à l'origine==, et deux points suffisent à retrouver les deux.")
    ])
}
