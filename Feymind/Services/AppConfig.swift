...
/// Configuration du backend IA. Les valeurs par défaut ciblent le projet Supabase de Feymind
/// et restent modifiables depuis l'écran Profil sans recompiler.
enum AppConfig {
    enum Key {
        static let supabaseURL = "feymind.supabaseURL"
        static let supabaseAnonKey = "feymind.supabaseAnonKey"
        static let aiModel = "feymind.aiModel"
    }
