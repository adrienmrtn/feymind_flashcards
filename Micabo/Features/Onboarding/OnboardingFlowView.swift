...
struct OnboardingFlowView: View {
    ...
    private var stepView: some View {
        ...
        case .demoCard: DemoCardStepView()
        case .demoPlan: DemoPlanStepView()
        case .demoMock: DemoMockStepView()
        case .demoEvidence: DemoEvidenceStepView()
        case .demoReviews: DemoReviewsStepView()
        ...
        case .pathReady: PathReadyStepView()
        ...
        case .proUnlocks: ProUnlocksStepView()
