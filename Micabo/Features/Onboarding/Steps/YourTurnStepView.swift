...
/// l'encre — le seul autre écran sombre est l'accroche, et les deux sont exactement les
/// deux moments où le parcours s'adresse à quelqu'un plutôt que de lui montrer quelque
/// chose.
///
