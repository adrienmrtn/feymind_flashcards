...
enum SubjectDisplay {
    ...
    static let families: [String: [UiLocale: String]] = [
        "Sciences": [.fr: "Sciences", .de: "Naturwiss.", .es: "Ciencias", .tr: "Bilimler"],
        "Santé": [.fr: "Santé", .de: "Gesundheit", .es: "Salud", .tr: "Sağlık"],
        "Sciences humaines": [.fr: "Sciences humaines", .de: "Geisteswiss.", .es: "Humanidades", .tr: "Beşeri bilimler"],
        "Langues": [.fr: "Langues", .de: "Sprachen", .es: "Idiomas", .tr: "Diller"],
        "Droit & économie": [.fr: "Droit & économie", .de: "Recht & Wiwi", .es: "Derecho y economía", .tr: "Hukuk ve ekonomi"],
        "Technique": [.fr: "Technique", .de: "Technik", .es: "Técnica", .tr: "Teknik"],
        "Et aussi": [.fr: "Et aussi", .de: "Und auch", .es: "Y también", .tr: "Ayrıca"],
    ]
