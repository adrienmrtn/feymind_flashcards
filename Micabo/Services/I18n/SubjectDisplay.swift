...
/// Libellés d'affichage. La valeur stockée reste le français du catalogue.
enum SubjectDisplay {
    static func family(_ name: String, locale: UiLocale) -> String {
        families[name]?[locale] ?? name
    }

    static func subject(_ name: String, locale: UiLocale) -> String {
        subjects[name]?[locale] ?? name
    }

    static let families: [String: [UiLocale: String]] = [
        "Sciences": [.en: "Science", .fr: "Sciences", .de: "Naturwiss.", .es: "Ciencias", .tr: "Bilimler"],
        "Santé": [.en: "Health", .fr: "Santé", .de: "Gesundheit", .es: "Salud", .tr: "Sağlık"],
        "Sciences humaines": [.en: "Humanities", .fr: "Sciences humaines", .de: "Geisteswiss.", .es: "Humanidades", .tr: "Beşeri bilimler"],
        "Langues": [.en: "Languages", .fr: "Langues", .de: "Sprachen", .es: "Idiomas", .tr: "Diller"],
        "Droit & économie": [.en: "Law & business", .fr: "Droit & économie", .de: "Recht & Wiwi", .es: "Derecho y economía", .tr: "Hukuk ve ekonomi"],
        "Technique": [.en: "Engineering", .fr: "Technique", .de: "Technik", .es: "Técnica", .tr: "Teknik"],
        "Et aussi": [.en: "And also", .fr: "Et aussi", .de: "Und auch", .es: "Y también", .tr: "Ayrıca"],
    ]

    static let subjects: [String: [UiLocale: String]] = [
        "Mathématiques": [.en: "Maths", .fr: "Mathématiques", .de: "Mathematik", .es: "Matemáticas", .tr: "Matematik"],
        ...
        "Kinésithérapie": [.en: "Physiother.", .fr: "Kinésithérapie", .de: "Physioth.", .es: "Fisioterapia", .tr: "Fizyoterapi"],
        ...
        "Sciences politiques": [.en: "Politics", .fr: "Sciences politiques", .de: "Politik", .es: "Ciencias políticas", .tr: "Siyaset"],
        ...
        "Informatique": [.en: "Computing", .fr: "Informatique", .de: "Informatik", .es: "Informática", .tr: "Bilişim"],
        ...
        "Génie civil": [.en: "Civil eng.", .fr: "Génie civil", .de: "Bauwesen", .es: "Obra civil", .tr: "İnşaat"],
        "Architecture": [.en: "Architecture", .fr: "Architecture", .de: "Architektur", .es: "Arquitectura", .tr: "Mimarlık"],
        "Arts": [.en: "Art", .fr: "Arts", .de: "Kunst", .es: "Artes", .tr: "Sanat"],
        ...
        "Code de la route": [.en: "Driving theory", .fr: "Code de la route", .de: "Führerschein", .es: "Tráfico", .tr: "Trafik"],
