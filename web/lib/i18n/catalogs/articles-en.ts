...
export const articlesEn = {
  shared: {
    ...
    ctaBody: "The first one is free, on the site and on iPhone.",
  },
  method: {
    ...
    active2:
      "That is also why a flashcard carries **one thing to retrieve**. A card that asks for five items at once cannot be graded: you recall three, and there is no button for “three fifths”.",
  ...
  exam: {
    ...
    lead2:
      "Exam mode gives the scheduler what it is missing: **a deadline**. You set exam day, it replans the deck around it.",
    ...
    limits1:
      "It does not manufacture time. Declaring an exam for tomorrow on two hundred new cards gives an honest and unsustainable plan, and Micabo shows it as-is rather than reassuring you.",
    limits2:
  ...
  anki: {
    ...
    metaDescription:
      "Anki is free, open, and excellent. Micabo writes the cards from your course and replans everything around an exam date. An honest comparison, including where Anki wins.",
    eyebrow: "Comparison",
    h1: "Micabo or Anki: what actually changes",
    lead1:
      "Anki is a very good program. It is free, open, it has twenty years of track record and a community that has documented everything. If you already use it and it works for you, you have no reason to switch.",
    lead2:
    ...
    tableLead:
      "Three lines go to Anki, including the most important one for a lot of people: it costs nothing.",
    ...
    rowWriteMicabo:
      "The course becomes a sheet, the sheet becomes cards. You reread and you correct.",
    ...
    rowPrice: "The price",
    rowPriceMicabo:
      "One free course, {cards} cards per session. Beyond that, {price} a year.",
    rowPriceAnki: "Free and open source, except the iPhone app.",
    ...
    costTitle: "Anki's cost is not its price",
    cost1:
      "A useful Anki deck for a college course is two to four hours of typing per chapter: splitting, writing one question per idea, not stacking five items on a card. That work is instructive — denying it would be dishonest — but it is the work that makes you open Anki in September and not again in November.",
    cost2:
    ...
    pickAnki:
      "**Stay on Anki** if you like tuning your scheduler, if you want FSRS, if you are on Android, or if you want a free and open tool whose files you own.",
    pickMicabo:
