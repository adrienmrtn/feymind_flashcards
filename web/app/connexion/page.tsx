      ...
      {sent ? (
        ...
        <form onSubmit={sendLink} className="space-y-2.5">
          ...
          <button
            ...
            className="pressable flex h-14 w-full items-center justify-center gap-2.5 rounded-button bg-ink text-[16px] font-semibold text-on-ink disabled:cursor-not-allowed disabled:bg-surface-sunken disabled:text-ink-tertiary"
          >
            {pending === "email" ? (
              <>
