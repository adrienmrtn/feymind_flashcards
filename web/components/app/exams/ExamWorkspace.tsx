    ...
    <li>
      ...
      >
        <span className="min-w-0">
          <span className="block truncate text-[15.5px] font-semibold text-ink">{name}</span>
          <span className="mt-0.5 block truncate text-[12.5px] text-ink-tertiary">{courses}</span>
        </span>
